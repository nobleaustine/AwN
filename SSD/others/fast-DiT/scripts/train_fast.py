...
sys.path.append('/cluster/home/austinen/NTNU/SSD/fast-DiT/')
...
from models.AWN_fast import DiT_models
...
def main(args):
    ...
    transform = transforms.Compose([transforms.ToTensor(),transforms.Lambda(lambda x: x.to(torch.float32))]) 
    dataset = CTDataset("/cluster/home/austinen/NTNU/DATA/training", transform=transform)
        ...
        for x, y in loader:
            ...
            if train_steps % args.log_every == 0:
                ...
                if accelerator.is_main_process:
                    ...
                    logger.info(f"Data Time: {data_time:.4f}, Train Time: {train_time:.4f}, Backward Time: {backward_time:.4f}")
