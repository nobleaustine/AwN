...
def DiT_XL_2(**kwargs):
    return DiT(depth=6, hidden_size=1024, patch_size=4, num_heads=8, **kwargs)
...
def DiT_B_2(**kwargs):
    return DiT(depth=6, hidden_size=768, patch_size=2, num_heads=12, **kwargs) # 12
...
def DiT_S_2(**kwargs):
    return DiT(depth=6, hidden_size=384, patch_size=2, num_heads=6, **kwargs) # 12
