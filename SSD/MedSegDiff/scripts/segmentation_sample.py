...
from MedSegDiff.guided_diffusion.dataset_loaders.bratsloader import BRATSDataset, BRATSDataset3D
from MedSegDiff.guided_diffusion.dataset_loaders.isicloader import ISICDataset
...
def main():
    ...
    for _ in range(len(data)):
        ...
        logger.log("sampling...")
        file_path = "/cluster/home/austinen/NTNU/MedSegDiff/GPU11TrainedModel/prediction/" + slice_ID + "_output_ens.jpg"
